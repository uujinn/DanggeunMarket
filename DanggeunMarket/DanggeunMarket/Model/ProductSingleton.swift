...
class product {
    ...
    var productArray:[productInfo] = [
        ...
        productInfo(id: "작심삼일을삼일에한번", productImage: UIImage(named: "mouse.jpg")!, productTitle: "버티컬 마우스", price: 24000, location: "노량진동", info: "35000주고 구매했는데요.\n얼마쓰지도 않고 컴퓨터 사용할 일이 없어져서 마우스도 덩달아 안쓰게 됐네요ㅠ\n손목이 정말 편안해요.", category: "디지털기기")
    ]
